    ...
    return (
      ...
      <React.Fragment>
        <TableRow sx={{ '& > *': { borderBottom: 'unset' } }}>
          ...
          <TableCell sx={{fontSize: 16}} align="center" >{request.firstName}</TableCell>
          <TableCell sx={{fontSize: 16}} align="center">{request.lastName}</TableCell>
          <TableCell sx={{fontSize: 16}} align="center">{request.type}</TableCell>
              ...
              <Box sx={{ margin: 1 }}>
                ...
                <div >
                    ...
                    <Typography variant="body1" gutterBottom component="div" sx={{color:"#5f6d5f"}}>
                        Address:
                        <label className="textItem"> {request.street + ", " + request.city + ", " + request.state} </label>
                    </Typography>
                 <Typography variant="body1" gutterBottom component="div" sx={{color:"#5f6d5f"}}>
                        Phone number: 
...
function RegistrationRequestsList(){
    ...
    return (
      ...
      />
      {requests.length == 0 && <Typography variant="h6" sx={{color:"#CC7351"}}>There are currently no registration requests</Typography>}
    </div>
    )
}
