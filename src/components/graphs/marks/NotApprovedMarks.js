        ...
        <React.Fragment>
          <TableRow sx={{ "& > *": { borderBottom: "unset" } }}>
            ...
            <TableCell sx={{ fontSize: 16 }} align="center">
              {request.reservationDTO.offerName}
            </TableCell>
            <TableCell
              sx={{ fontSize: 16 }}
              align="center"
            >{`${request.reservationDTO.clienName} ${request.reservationDTO.clientLastName}`}</TableCell>
            <TableCell sx={{ fontSize: 16 }} align="center">
              {request.mark}
            </TableCell>
            <TableCell sx={{ fontSize: 16 }} align="center">
                ...
                <Box sx={{ margin: 1 }}>
                  ...
                  >
                    ...
                    <label className="textItem">
                      {" "}
                      {`${request.reservationDTO.startDate}  -  ${request.reservationDTO.endDate}`}{" "}
                    </label>
                  </Typography>
                  <Typography
                    variant="body1"
                  ...
                  >
                    ...
                    <label className="textItem">
                      {" "}
                      {request.reservationDTO.numberOfPerson}{" "}
                    </label>
                  </Typography>
                  <Typography
                    variant="body1"
                  ...
                  >
                    ...
                    <label className="textItem">
                      {" "}
                      {request.reservationDTO.price} e
                    </label>
                  </Typography>
                </Box>
              </Collapse>
          ...
          <Table aria-label="collapsible table">
            <TableHead>
              <TableRow sx={{ borderBottom: "solid #99A799" }}>
                <TableCell>
                  <img width="60" height={"60"} src={ratingIcon}></img>{" "}
                </TableCell>
                <TableCell
                ...
                <TableCell
                  ...
                  align="center"
                >
                  <Typography variant="button">Mark</Typography>
                </TableCell>
                <TableCell
                  sx={{ fontWeight: "bold", color: "#5f6d5f", fontSize: 18 }}
                  align="center"
