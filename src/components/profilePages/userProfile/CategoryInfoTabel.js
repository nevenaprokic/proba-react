...
export default function CategoryInfoTabel({ categoryType, userCategory }) {
  ...
  if (!!categories) {
    return (
      <TableContainer
        component={Paper}
        sx={{ width: "50%", marginLeft: "25%", marginTop: "10%" }}
      >
        <Table sx={{ minWidth: 650 }} aria-label="simple table">
          <TableHead>
            <TableRow>
              <TableCell sx={{ color: "#CC7351" }}>Category name</TableCell>
              <TableCell align="right" sx={{ color: "#CC7351" }}>
                Points for successfull reservation
              </TableCell>
              <TableCell align="right" sx={{ color: "#CC7351" }}>
                Lower limit
              </TableCell>
              ...
              <TableCell align="right" sx={{ color: "#CC7351" }}>
                {categoryType == userType.CLIENT
                  ? "Discount for reservation (%)"
                  : "Earnings from reservation (%)"}
              </TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
