...
import { getReservationDetails, getQuickActionDetails } from '../../services/CalendarService';
    ...
    useEffect(() => {
        async function set(){
            if(!!actionId){
                ...
                console.log("detalji", action.data);
            ...
            <CardActionArea component="a" href="#">
                ...
                <CardContent sx={{ flex: 1 }}>
                    ...
                    <Typography variant="subtitle1" color="text.secondary">
                         Action available:{actionData.startDateActionStr} - {actionData.endDateActionStr}
                    </Typography>
                    <Typography variant="subtitle1" color="text.secondary">
                         Realization period: {actionData.startDateStr} - {actionData.endDateStr}
                    </Typography>
                    <div>
