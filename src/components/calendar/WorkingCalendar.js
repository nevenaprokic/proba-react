...
export default function WorkingCalendar({ offers, setOffers }) {
  ...
  function handleCLoseUnavailableDatesForm() {
    setUnavailableDatesForm(false);
  }
    ...
    return (
      <div className="demo-app">
        ...
        <Modal
          ...
          sx={{ backgroundColor: "rgb(218, 224, 210, 0.6)", overflow: "auto" }}
        >
          <AddUnavailableOfferDates
            offerId={offerId}
            offerName={offerName}
            close={handleCLoseUnavailableDatesForm}
        ...
        >
          <QuickActionDetails
            ...
            close={handleCloseActionDetails}
          />
        </Modal>
      </div>
    );
