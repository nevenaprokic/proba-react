    ...
    return (
        ...
        <Grid container spacing={3} component="form" noValidate onSubmit={handleSubmit(onSubmit)} sx={{marginTop:"2%"}}>
                ...
                <TextField
                    ...
                    {...register("bedNumber", {required:true, pattern:/^[1-9]+[0-9]*$/})} 
                />
                {errors.bedNumber && <label className="requiredLabel">Only positive numbers are allowed</label>}
                </Grid>
                <Grid item xs={12} sm={6} >
                <TextField
                    id="roomNumber"
                    ...
                    {...register("roomNumber", {required:true, pattern:/^[1-9]+[0-9]*$/})}
                />
                {errors.roomNumber && <label className="requiredLabel">Only positive numbers are allowed</label>}
                </Grid>
