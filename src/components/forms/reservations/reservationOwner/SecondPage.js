...
export default function SecondPage({setReservation, reservation, offers, checked, setChecked}) {
  ...
  return (
    <React.Fragment>
      ...
      <Grid item xs={12}>
                <label style={{ marginLeft:"20%",marginBottom:"5%", color:"#CC7351", fontSize:"25px"  }}>{"The reservation offer is " + reservation.offerName + "."}</label>
            </Grid>
      <Grid item xs={12} sm={4}>
        ...
        <Grid item xs={12}>
                <label style={{marginBottom:"5%", color:"#CC7351", fontSize:"23px"  }}>{"Basic price:  " + reservation.price + "€"}</label>
                <br></br>
