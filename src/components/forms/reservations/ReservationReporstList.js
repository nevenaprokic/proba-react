        ...
        <React.Fragment>
          <TableRow sx={{ "& > *": { borderBottom: "unset" } }}>
            ...
            <TableCell sx={{ fontSize: 16 }} align="center">
              {report.reservationDTO.offerName}
            </TableCell>
            <TableCell
              sx={{ fontSize: 16 }}
              align="center"
            >{`${report.reservationDTO.clienName} ${report.reservationDTO.clientLastName}`}</TableCell>
            <TableCell sx={{ fontSize: 16 }} align="center">
                ...
                <Box sx={{ margin: 1 }}>
                  ...
                  >
                    ...
                    <label className="textItem">
                      {" "}
                      {`${report.reservationDTO.startDate}  -  ${report.reservationDTO.endDate}`}{" "}
                    </label>
                  </Typography>
                  <Typography
                    variant="body1"
                  ...
                  >
                    ...
                    <label className="textItem">
                      {" "}
                      {report.reservationDTO.numberOfPerson}{" "}
                    </label>
                  </Typography>
                  <Typography
                    variant="body1"
                  ...
                  >
                    ...
                    <label className="textItem">
                      {" "}
                      {`${report.clientDTO.firstName} ${report.clientDTO.lastName}`}{" "}
                    </label>
                  </Typography>
                  <Typography
                    variant="body1"
                  ...
                  >
                    ...
                    <label className="textItem">
                      {" "}
                      {`${report.clientDTO.clientCategory}`}{" "}
                    </label>
                  </Typography>
                  <Typography
                    variant="body1"
    ...
    return (
      <div className="requestsC ontainer">
        <Typography variant="h6" sx={{ color: "#5f6d5f" }}>
          As an administrator, you are able to add penalty points to clients
          depending on their behaviour during the reservation.
        </Typography>
        <Divider />
