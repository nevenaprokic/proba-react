...
import {deleteClientCategory, deleteOwnerCategory, deleteCategory } from "../../../services/LoyaltyService";
...
export default function DeleteCategory({closeDialog, open, category, categoryType, setLoyaltyCategories}) {
    const handleClose = () => {
        closeDialog();
    }
